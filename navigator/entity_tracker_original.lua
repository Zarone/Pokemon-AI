...
-- print("loop")
-- print(sf("%x", ows+3+mode))
-- print(sf("%x", editat+ offset + mult))
-- 781 760
_, x, y = get_local_info()
gui.text(1, 50, x)
gui.text(1, 60, y)
-- print(sf("%x", editat + 227*mult - 2 + 16*14))

print(mult)

gui.text(1, 80, sf("%d", memory.readword(editat + 227*24 - 2 + 16*14)))
gui.text(1, 90, sf("%d", memory.readword(editat + 227*24 + 6 + 16*14)))
gui.text(1, 100, sf("%d", memory.readword(editat + 227*24 - 2 + 16*30)))
gui.text(1, 110, sf("%d", memory.readword(editat + 227*24 + 6 + 16*30)))
