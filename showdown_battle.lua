...
---- Just a reminder until I look at this file again,
---- I couldn't get it to work, but I want it here for a bit
---- in case I need it
...
--     -- while fileText == "" do
--     --     fileInfo = io.open("./battle_ai/state_files/thisCurrentState.json", "r")
--     --     fileText = fileInfo:read("a")
