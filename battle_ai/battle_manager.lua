...
function BattleManager:get_action()
    ...
    -- self.showdown_instance:write(">p1 switch "..tostring(self.game_reader.active).."\n")
    -- self.showdown_instance:write(">p2 switch "..tostring(self.game_reader.enemy_active).."\n")
